...
export const DEFAULT_USER_COPY = {
    ...
    connection_required: "Tap Connect for this app below to sign in, then I'll continue.",
    connection_refresh_failed: "Tap Connect below to refresh this app, then I'll continue.",
